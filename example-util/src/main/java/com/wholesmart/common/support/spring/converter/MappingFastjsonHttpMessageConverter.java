...
public class MappingFastjsonHttpMessageConverter //
    ...
    public MappingFastjsonHttpMessageConverter() {
        ...
        super(MediaType.ALL);
        this.fastJsonConfig.getSerializeConfig().put(Long.class, new LongIdSerializer());//添加全局转换配置
        this.fastJsonConfig.getSerializeConfig().put(Date.class, new DateSerializer());
    }
